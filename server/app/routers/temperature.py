...
def get_record_from_to(
    from_date: str = Query(..., description="From date in YYYY-MM-DD format (optionally add time as well by adding THH:MM:SS)"), 
    to_date: str = Query(..., description="To date in YYYY-MM-DD format (optionally add time as well by adding THH:MM:SS)"),
